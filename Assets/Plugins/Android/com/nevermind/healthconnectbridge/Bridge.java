package com.nevermind.healthconnectbridge;
...
public final class Bridge extends Application {
    ...
    //just name
    static final String QUEST_AREAS="quest_areas";
    //0:Walking through hills,10:Going Down
    ...
    public static void ReceiveActivityInstance(Activity tempActivity) {
        ...
        Log.i("PEDOMETER", "RECEIVE ACTIVITY");
        Log.i("PEDOMETER", tempActivity.toString());
    ...
    public static void StartService() {
        Log.i("PEDOMETER", "START SERVICE");
        if (myActivity != null) {
            Log.i("PEDOMETER", "activity is not null");
            ...
            Log.i("PEDOMETER", "activity is null");
            start();
        }
    }

    private static void start(){
        Log.i("PEDOMETER", "START ACTIVITY 1");
